...
object FromParams {
  ...
  implicit def hconsFromParams[F[_]: Effect, HK <: Symbol, HV, T <: HList](
      implicit
      key: Witness.Aux[HK],
      fpt: FromParams[F, T],
...
private[generic] object Extractor extends Poly1 {
  ...
  implicit def optionalExtractor[F[_]: Effect, V](
      implicit
      dh: DecodeEntity[V],
      ct: ClassTag[V]
  ...
  implicit def seqExtractor[F[_]: Effect, V](
      implicit
      dh: DecodeEntity[V],
      ct: ClassTag[V]
  ...
  implicit def nelExtractor[F[_]: Effect, V](
      implicit
      dh: DecodeEntity[V],
      ct: ClassTag[V]
  ...
  implicit def extractor[F[_]: Effect, V](
      implicit
      dh: DecodeEntity[V],
      ct: ClassTag[V]
