...
package object circe extends Encoders with Decoders {
  ...
  /** Provides a [[io.circe.Printer]] that drops null keys. */
  ...
  /** Provides a [[io.circe.Printer]] that uses a simple form of feedback-controller to predict the size of the printed message. */
