...
@State(Scope.Benchmark)
class MapperBenchmark extends FinchBenchmark {
  ...
  val function1ResponseEndpoint: Endpoint[Response] = get(path[Int])((_: Int) => Response())
  val function1OutputEndpoint: Endpoint[String] = get(path[Int])((_: Int) => Ok("foo"))
  val function1FutureResponseEndpoint: Endpoint[Response] = get(path[Int])((_: Int) => Future.value(Response()))
  val function1FutureOutputEndpoint: Endpoint[String] = get(path[Int])((_: Int) => Future.value(Ok("foo")))

  val functionNResponseEndpoint: Endpoint[Response] = get(path[Int] :: path[Int])((_: Int, _: Int) => Response())
  val functionNOutputEndpoint: Endpoint[String] = get(path[Int] :: path[Int])((_: Int, _: Int) => Ok("foo"))
  val functionNFutureResponseEndpoint: Endpoint[Response] = get(path[Int] :: path[Int])((_: Int, _: Int) =>
