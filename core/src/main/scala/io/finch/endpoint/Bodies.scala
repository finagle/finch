...
trait BodyEndpoints[F[_]] {
  ...
  /**
    ...
    */
  def binaryBodyOption(implicit effect: Effect[F]): Endpoint[F, Option[Array[Byte]]] = {
  ...
  /**
    ...
    */
  def binaryBody(implicit effect: Effect[F]): Endpoint[F, Array[Byte]] = {
    val bodies = new Bodies[F]
  ...
  /**
    ...
    */
  def stringBodyOption(implicit effect: Effect[F]): Endpoint[F, Option[String]] = {
    val bodies = new Bodies[F]
  ...
  /**
    ...
    */
  def stringBody(implicit effect: Effect[F]): Endpoint[F, String] = {
    val bodies = new Bodies[F]
  ...
  /**
    ...
    */
  def jsonBody[A: Decode.Json : ClassTag](implicit effect: Effect[F]): Endpoint[F, A] =
    body[A, Application.Json]

  /**
    * Alias for `bodyOption[A, Application.Json]`.
    */
  def jsonBodyOption[A: Decode.Json : ClassTag](implicit effect: Effect[F]): Endpoint[F, Option[A]] =
    bodyOption[A, Application.Json]

  /**
    * Alias for `body[A, Text.Plain]`
    */
  def textBody[A: Decode.Text : ClassTag](implicit effect: Effect[F]): Endpoint[F, A] =
    body[A, Text.Plain]

  /**
    * Alias for `bodyOption[A, Text.Plain]`
    */
  def textBodyOption[A: Decode.Text : ClassTag](implicit effect: Effect[F]): Endpoint[F, Option[A]] =
  ...
  /**
    ...
    */
  def asyncBody(implicit effect: Effect[F]): Endpoint[F, AsyncStream[Buf]] = new Endpoint[F, AsyncStream[Buf]] {
