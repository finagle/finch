...
abstract private[finch] class Attribute[F[_]: Effect, G[_], A](
    val name: String
  )(implicit
    d: DecodeEntity[A],
    tag: ClassTag[A])
...
abstract private[finch] class FileUpload[F[_]: Effect, G[_]](name: String) extends Endpoint[F, G[FinagleMultipart.FileUpload]] {
