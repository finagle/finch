...
private[finch] trait LowPriorityMapperConversions {
  ...
  /**
    ...
    */
  @deprecated(
    "com.twitter.util.Future use is deprecated in Endpoints. Consider to use cats-effect compatible effect",
    "0.25.0"
  )
  implicit def mapperFromFutureOutputFunction[A, B, F[_]: Effect](
    f: A => TwitterFuture[Output[B]]
  ): Mapper.Aux[F, A, B] =
    instance(_.mapOutputAsync(a => twitterFutureToEffect(f(a))))
  ...
  implicit def mapperFromFutureResponseFunction[A, F[_]: Effect](
    f: A => TwitterFuture[Response]
  ): Mapper.Aux[F, A, Response] =
  ...
  /**
    ...
    */
  @deprecated(
    "scala.concurrent.Future use is deprecated in Endpoints. Consider to use cats-effect compatible effect",
    "0.25.0"
  )
  implicit def mapperFromScFutureOutputFunction[A, B, F[_]: Effect](
    f: A => ScalaFuture[Output[B]]
  ): Mapper.Aux[F, A, B] =
    instance(_.mapOutputAsync(a => scalaFutureToEffect(f(a))))
  ...
  implicit def mapperFromScFutureResponseFunction[A, F[_]: Effect](
    f: A => ScalaFuture[Response]
  ): Mapper.Aux[F, A, Response] =
...
private[finch] trait HighPriorityMapperConversions extends LowPriorityMapperConversions {
  ...
  /**
    ...
    */
  implicit def mapperFromOutputHFunction[F[_]: Monad, A, B, FN, OB](f: FN)(
    implicit
   ...
   * @group HighPriorityMapper
   */
  implicit def mapperFromResponseHFunction[F[_]: Monad, A, FN, R](f: FN)(
    implicit
  ...
  implicit def mapperFromFutureResponseValue[F[_]: Effect](
    fr: => TwitterFuture[Response]
  ): Mapper.Aux[F, HNil, Response] =
  ...
  implicit def mapperFromScFutureResponseValue[F[_]: Effect](
    fr: => ScalaFuture[Response]
  ): Mapper.Aux[F, HNil, Response] =
...
object Mapper extends HighPriorityMapperConversions {
  implicit def mapperFromEffectOutputHFunction[F[_]: Monad, A, B, FN, FOB](f: FN)(
    implicit
    ftp: FnToProduct.Aux[FN, A => FOB],
    ev: FOB <:< F[Output[B]]
  ): Mapper.Aux[F, A, B] = instance(_.mapOutputAsync(value => ev(ftp(f)(value))))

  implicit def mapperFromEffectResponseHFunction[F[_]: Monad, A, FN, FR](f: FN)(
    implicit
  ...
  implicit def mapperFromFutureOutputHFunction[F[_]: Effect, A, B, FN, FOB](f: FN)(
    implicit
    ftp: FnToProduct.Aux[FN, A => FOB],
  ...
  implicit def mapperFromFutureResponseHFunction[F[_]: Effect, A, FN, FR](f: FN)(
    implicit
    ftp: FnToProduct.Aux[FN, A => FR],
  ...
  implicit def mapperFromScFutureOutputHFunction[F[_]: Effect, A, B, FN, FOB](f: FN)(
    implicit
    ftp: FnToProduct.Aux[FN, A => FOB],
  ...
  implicit def mapperFromScFutureResponseHFunction[F[_]: Effect, A, FN, FR](f: FN)(
    implicit
    ftp: FnToProduct.Aux[FN, A => FR],
