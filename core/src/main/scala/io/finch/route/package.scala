...
package object route extends Endpoints {
  ...
  @deprecated("Use io.finch.Endpoint instead", "0.9.1")
  type Router[A] = Endpoint[A]
  @deprecated("Use io.finch.Endpoint0 instead", "0.9.1")
  type Router0 = Endpoint[HNil]
  @deprecated("Use io.finch.Endpoint2 instead", "0.9.1")
  type Router2[A, B] = Endpoint[A :: B :: HNil]
  @deprecated("Use io.finch.Endpoint3 instead", "0.9.1")
