...
lazy val generic =
  project.settings(moduleName := "finchx-generic").settings(allSettings).dependsOn(core % "compile->compile;test->test")
...
lazy val sse = project.settings(moduleName := "finchx-sse").settings(allSettings).dependsOn(core)
