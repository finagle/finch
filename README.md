...
libraryDependencies ++= Seq(
  "com.github.finagle" %% "[finch-module]" % "0.9.1"
)
```
...
libraryDependencies ++= Seq(
  "com.github.finagle" %% "[finch-module]" % "0.9.2-SNAPSHOT" changing()
)
```

Hello World!
------------
This "Hello World!" example is built with the `0.9.2-SNAPSHOT` version of `finch-core`.
